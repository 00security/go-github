...
type GetAuditLogOptions struct {
	Phrase  *string `json:"phrase,omitempty" url:"phrase"`   // A search phrase. (Optional.)
	Include *string `json:"include,omitempty" url:"include"` // Event type includes. Can be one of "web", "git", "all". Default: "web". (Optional.)
	Order   *string `json:"order,omitempty" url:"order"`     // The order of audit log events. Can be one of "asc" or "desc". Default: "desc". (Optional.)
