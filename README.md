...
[![GoDoc](https://img.shields.io/static/v1?label=godoc&message=reference&color=blue)](https://pkg.go.dev/github.com/00security/go-github/v41/github)
...
```bash
go get github.com/00security/go-github/v41
```
...
```go
import "github.com/00security/go-github/v41/github"
```
...
```bash
go get github.com/00security/go-github/v41@master
```
...
[package docs]: https://pkg.go.dev/github.com/00security/go-github/v41/github
